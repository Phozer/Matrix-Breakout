...
# 1 "./inc/PBA_config.h" 1
# 130 "./inc/PBA_config.h"
#pragma jis
# 179 "./inc/PBA_config.h"
...
# 1 "./inc/PBA_helpers.h" 1
# 75 "./inc/PBA_helpers.h"
...
# 190 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_i2c.h" 1
# 42 "./inc/PBA_driver_i2c.h"
...
# 193 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_lcd.h" 1
# 78 "./inc/PBA_driver_lcd.h"
typedef enum
{
    V_3V3,
    V_5V
}displayVoltage_t;
# 94 "./inc/PBA_driver_lcd.h"
...
# 196 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_adc.h" 1
# 205 "./inc/PBA_driver_adc.h"
...
# 199 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_lm75.h" 1
# 43 "./inc/PBA_driver_lm75.h"
void LM75_Init(void);
int16_t LM75_ReadTemp(void);
# 202 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_uart.h" 1
# 42 "./inc/PBA_driver_uart.h"
void UART_Init(void);
...
# 205 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_loopdelay.h" 1
# 56 "./inc/PBA_loopdelay.h"
...
# 208 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_events.h" 1
# 45 "./inc/PBA_events.h"
typedef struct
{
    unsigned switch0: 1;
...
# 211 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_interrupts.h" 1
# 45 "./inc/PBA_interrupts.h"
...
# 217 "./inc/PBA_config.h" 2


# 1 "./inc/PBA_driver_eeprom.h" 1
# 43 "./inc/PBA_driver_eeprom.h"
void EE_WriteByte(uint8_t eeAddr, uint8_t eeData);


uint8_t EE_ReadByte(uint8_t eeAddr);
# 220 "./inc/PBA_config.h" 2
...
void main(void) {
  ...
  unsigned char tilt_count = 0;
    ...
    while(1){
      xGyro = LSM330_read((0xD6), 40);
      yGyro = LSM330_read((0xD6), 42);
      zGyro = LSM330_read((0xD6), 44);

      xAccl = LSM330_read((0x32), 40);
      yAccl = LSM330_read((0x32), 42);
      zAccl = LSM330_read((0x32), 44);
...
int16_t LSM330_read(char Addr, char RegAddress)
{
    ...
    I2C_Start();
    I2C_WriteByte(Addr);
    I2C_WriteByte(RegAddress+1);
    I2C_Restart();
    I2C_WriteByte(Addr+(0x01));
    dataH=I2C_ReadByte(0);
    I2C_Stop();
