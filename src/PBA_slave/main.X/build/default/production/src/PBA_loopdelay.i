...
# 2 "<built-in>" 2
# 1 "src/PBA_loopdelay.c" 2
# 39 "src/PBA_loopdelay.c"
...
# 40 "src/PBA_loopdelay.c" 2
# 80 "src/PBA_loopdelay.c"
...
__attribute__((inline)) void LOOPDELAY_TimerISR(void)
{
# 111 "src/PBA_loopdelay.c"
    if (loopDelayCnt < 10000)
        loopDelayCnt++;
...
# 168 "src/PBA_loopdelay.c"
    T2CON = 0b01001101;



    PR2 = ((32000000/160000UL))-1;
    TMR2 = 0;
    PIR1bits.TMR2IF = 0;
    PIE1bits.TMR2IE = 1;
