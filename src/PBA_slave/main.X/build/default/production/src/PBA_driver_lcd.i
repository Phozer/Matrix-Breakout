...
# 2 "<built-in>" 2
# 1 "src/PBA_driver_lcd.c" 2
# 39 "src/PBA_driver_lcd.c"
...
{
    LATCbits.LATC1=1;
    LATAbits.LATA5 = (((value) & (1 << (3)))>0);
    LATAbits.LATA4 = (((value) & (1 << (2)))>0);
    LATAbits.LATA2 = (((value) & (1 << (1)))>0);
    LATEbits.LATE2 = (((value) & (1 << (0)))>0);
    LATCbits.LATC1=0;
    DelayUS(30);
}
...
{
    LATCbits.LATC1=1;
    LATAbits.LATA5 = (((value) & (1 << (7)))>0);
    LATAbits.LATA4 = (((value) & (1 << (6)))>0);
    LATAbits.LATA2 = (((value) & (1 << (5)))>0);
    LATEbits.LATE2 = (((value) & (1 << (4)))>0);
    LATCbits.LATC1=0;
...
{
    uint8_t dispAddress;
    if(0 == posY) dispAddress = 0x00;
    if(1 == posY) dispAddress = 0x40;
    dispAddress += posX;
    LCD_SendByte((0b10000000 | dispAddress));
}
# 154 "src/PBA_driver_lcd.c"
static uint8_t LCD_GetSpecChar(uint8_t ch)
{
    switch (ch)
    {
...
void LCD_Putc(uint8_t ch)
{
    switch (ch)
    {
        ...
        default:
            LATCbits.LATC2=1;LCD_SendByte(LCD_GetSpecChar(ch));LATCbits.LATC2=0;
    }
}
...
void LCD_SetCursorMode(uint8_t cursorMode)
{
    LCD_SendByte(0b00001000|cursorMode);
}
# 229 "src/PBA_driver_lcd.c"
void LCD_Init(displayVoltage_t displayVoltage)
{
    DelayMS(40);
    LATCbits.LATC2=0;
    ...
    LCD_SendByte(0b00101001);
    if(V_3V3==displayVoltage)
    {
        LCD_SendByte(0b00010100);
        LCD_SendByte(0b01010101);
        LCD_SendByte(0b01101101);
        LCD_SendByte(0b01111000);
    }
    else if(V_5V==displayVoltage)
    {
        LCD_SendByte(0b00011100);
        LCD_SendByte(0b01010010);
        LCD_SendByte(0b01101001);
        LCD_SendByte(0b01110100);
    }
    LCD_SendByte(0b00101000);
    LCD_SendByte(0b00001100);
    LCD_SendByte(0b00000001);
    DelayMS(2);
    LCD_SendByte(0b00000110);
    LCD_SendByte(0b00101000);
    LCD_SendByte(0b00001100);
}
