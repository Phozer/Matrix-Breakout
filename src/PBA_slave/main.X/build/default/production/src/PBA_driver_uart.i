...
# 2 "<built-in>" 2
# 1 "src/PBA_driver_uart.c" 2
# 39 "src/PBA_driver_uart.c"
...
int isascii(int);
int toascii(int);
# 43 "src/PBA_driver_uart.c" 2
# 66 "src/PBA_driver_uart.c"
void UART_Init(void)
{
    TXSTA=0x20;
    RCSTA=0x90;
    SPBRG=(uint8_t)((uint16_t)(32000000/(4UL * 115200) -1));
    SPBRGH=((uint16_t)(32000000/(4UL * 115200) -1))>>8;
    TX1STAbits.BRGH = 1;
