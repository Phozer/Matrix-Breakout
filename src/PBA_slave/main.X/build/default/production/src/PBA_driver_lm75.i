...
# 2 "<built-in>" 2
# 1 "src/PBA_driver_lm75.c" 2
# 39 "src/PBA_driver_lm75.c"
...
int16_t LM75_ReadTemp(void)
{
    ...
    I2C_WriteByte(0x00);
    I2C_Restart();
    I2C_WriteByte((0x90)+(0x01));
    dataH=I2C_ReadByte(1);
    dataL=I2C_ReadByte(0);
    I2C_Stop();
    tempMult10=(int16_t)dataH*10;
    if((((dataL) & (1 << (7)))>0))
    {
        if(tempMult10 < 0) tempMult10 -=5;
        else tempMult10 += 5;
    }
    return(tempMult10);
 }
