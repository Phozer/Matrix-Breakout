...
# 2 "<built-in>" 2
# 1 "src/PBA_interrupts.c" 2
# 39 "src/PBA_interrupts.c"
...
# 40 "src/PBA_interrupts.c" 2
# 50 "src/PBA_interrupts.c"
static callbackFunction_t tmr0CallbackFunction[3]={((void*)0)};




static callbackFunction_t tmr1CallbackFunction[3]={((void*)0)};




static callbackFunction_t tmr2CallbackFunction[3]={((void*)0)};




static callbackFunction_t uartCallbackFunction = ((void*)0);




static callbackFunction_t extIntCallbackFunction = ((void*)0);
...
void __attribute__((picinterrupt(("")))) INT_Manager(void)
{

    if(INTCONbits.TMR0IF && INTCONbits.TMR0IE)
    {
        INTCONbits.TMR0IF = 0;
        if(((void*)0) != tmr0CallbackFunction[0])
        {
            for(uint8_t cnt=0; (cnt< 3) && (((void*)0) != tmr0CallbackFunction[cnt]); cnt++)
            {
                tmr0CallbackFunction[cnt]();
            }
        }
        else
        {
    ...
    {
        PIR1bits.TMR1IF=0;
         if(((void*)0) != tmr1CallbackFunction[0])
        {
            for(uint8_t cnt=0; (cnt< 3) && (((void*)0) != tmr1CallbackFunction[cnt]); cnt++)
            {
               tmr1CallbackFunction[cnt]();
            }
        }
        else
        {
    ...
    {
        PIR1bits.TMR2IF=0;
         if(((void*)0) != tmr2CallbackFunction[0])
        {
            for(uint8_t cnt=0; (cnt< 3) && (((void*)0) != tmr2CallbackFunction[cnt]); cnt++)
            {
                tmr2CallbackFunction[cnt]();
            }
        }
        else
        {
    ...
    {
        if(((void*)0) != uartCallbackFunction)
        {
    ...
    {
        INTCONbits.INTF=0;
        if(((void*)0) != extIntCallbackFunction)
        {
            extIntCallbackFunction();
        }
        else
        {
            UnhandledInterrupt();
...
uint8_t INT_AddTmr0CallbackFnc (callbackFunction_t p_callBackFunction)
{
    ...
    {
        if(tmr0CallbackFunction[cnt]==((void*)0))
        {
            tmr0CallbackFunction[cnt]=p_callBackFunction;
            return 0;
        }
    }
    return 1;
...
uint8_t INT_AddTmr1CallbackFnc (callbackFunction_t p_callBackFunction)
{
    for(uint8_t cnt=0; cnt<3; cnt++)
    {
        if(tmr1CallbackFunction[cnt]==((void*)0))
        {
            tmr1CallbackFunction[cnt]=p_callBackFunction;
            return 0;
        }
    }
    return 1;
...
uint8_t INT_AddTmr2CallbackFnc (callbackFunction_t p_callBackFunction)
{
    for(uint8_t cnt=0; cnt<3; cnt++)
    {
        if(tmr2CallbackFunction[cnt]==((void*)0))
        {
            tmr2CallbackFunction[cnt]=p_callBackFunction;
            return 0;
        }
    }
    return 1;
...
uint8_t INT_AddUartCallbackFnc (callbackFunction_t p_callBackFunction)
{
    if(uartCallbackFunction==((void*)0))
    {
        uartCallbackFunction=p_callBackFunction;
        return 0;
    }
    return 1;
}
...
uint8_t INT_AddExtIntCallbackFnc (callbackFunction_t p_callBackFunction)
{
    if(extIntCallbackFunction==((void*)0))
    {
        extIntCallbackFunction=p_callBackFunction;
        return 0;
    }
    return 1;
}
