...
# 2 "<built-in>" 2
# 1 "src/PBA_driver_i2c.c" 2
# 39 "src/PBA_driver_i2c.c"
...
# 40 "src/PBA_driver_i2c.c" 2
# 60 "src/PBA_driver_i2c.c"
void I2C_WaitIF(void)
{
...
void I2C_Init(void)
{
    ...
    APFCON1bits.SCKSEL = 1;
    APFCON1bits.SDISEL = 1;
    SSPADD=32000000/(4*100000)-1;
    SSPCON=0x08;
