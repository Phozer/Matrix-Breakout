...
# 2 "<built-in>" 2
# 1 "src/PBA_helpers.c" 2
# 39 "src/PBA_helpers.c"
...
void Beep(uint16_t freqHZ,uint16_t durationMS)
{
    ...
    uint32_t durationUS;
    uint32_t periodCnt;
    impulsTimeUS= 472500/freqHZ;
    durationUS=(uint32_t) durationMS*939;
    periodCnt=durationUS/(impulsTimeUS*2);
    for(;periodCnt>0;periodCnt--)
    {
        impulsTimeCnt=0;
        LATCbits.LATC5=1;
        while((impulsTimeCnt+=14)<=impulsTimeUS) _delay((unsigned long)((12)*(32000000/4000000.0)));
        impulsTimeCnt=0;
        LATCbits.LATC5=0;
        while((impulsTimeCnt+=14)<=impulsTimeUS) _delay((unsigned long)((12)*(32000000/4000000.0)));
    }
