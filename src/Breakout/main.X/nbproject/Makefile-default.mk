...
SOURCEFILES_QUOTED_IF_SPACED=main.c SPI.c DIGI_DOT_BOOSTER.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/SPI.p1.d ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1

# Source Files
SOURCEFILES=main.c SPI.c DIGI_DOT_BOOSTER.c
...
${OBJECTDIR}/DIGI_DOT_BOOSTER.p1: DIGI_DOT_BOOSTER.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1.d 
	@${RM} ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1 DIGI_DOT_BOOSTER.c 
	@-${MV} ${OBJECTDIR}/DIGI_DOT_BOOSTER.d ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/DIGI_DOT_BOOSTER.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
